...
model.add(tf.keras.layers.Dense(128, activation=activation_functions.activation_funcs[1]))
...
log_dir = "./logs/fit/"+"final4" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
